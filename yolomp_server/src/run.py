...
import pose_estimation                      # type: ignore
...
@app.route('/download_sequence/<string:file>', methods=['GET'])
def download_sequence(file):
    return flask.send_from_directory('../sequences', file, as_attachment=True)
